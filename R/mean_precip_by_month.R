...
#' @param water_year: From 2002 to 2019. The water year starts on October 1 and ends on September 30.
#' @param Location: Paso Robles, San Luis Obispo, and Santa Barbara
#' @param month: Three-letter abreviation of precipitation month
#' @param precip: Precipitation measured in inches
